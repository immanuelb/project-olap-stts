...
<!-- ./wrapper -->
	...
	<!-- jQuery 3 -->
	<script src="<?php echo base_url('resource/') ?>assets/vendor_components/jquery/dist/jquery.js"></script>

	<!-- jQuery UI 1.11.4 -->
	<script src="<?php echo base_url('resource/') ?>assets/vendor_components/jquery-ui/jquery-ui.min.js"></script>
	...
	<!-- Bootstrap 4.0-->
	<script src="<?php echo base_url('resource/') ?>assets/vendor_components/bootstrap/dist/js/bootstrap.js"></script>

	<!-- Morris.js charts -->
	<script src="<?php echo base_url('resource/') ?>assets/vendor_components/raphael/raphael.min.js"></script>
	<script src="<?php echo base_url('resource/') ?>assets/vendor_components/morris.js/morris.min.js"></script>

	<!-- daterangepicker -->
	<script src="<?php echo base_url('resource/') ?>assets/vendor_components/moment/min/moment.min.js"></script>
	<script src="<?php echo base_url('resource/') ?>assets/vendor_components/bootstrap-daterangepicker/daterangepicker.js"></script>

	<!-- fullCalendar -->
	<script src="<?php echo base_url('resource/') ?>assets/vendor_components/fullcalendar/dist/fullcalendar.js"></script>
	...
	<!-- Slimscroll -->
	<script src="<?php echo base_url('resource/') ?>assets/vendor_components/jquery-slimscroll/jquery.slimscroll.js"></script>
